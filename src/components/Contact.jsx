...
const socialLinks = [
    {
      href: 'https://github.com/OdehIgoche',
    ...
    {
      href: 'https://www.linkedin.com/in/anthony-igoche-8a1043230',
      icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      href: 'https://www.instagram.com/igoche_anthony/',
    ...
    >
     <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        ...
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
            <h2 className="headline-2 max-w-[12ch] reveal-up">
                Contact me for collaboration 
            </h2>

            <p className="text-zinc-400 mt-3 nb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
            ...
            mt-auto">
                ...
                {socialLinks.map(({ href, icon}, key)=>(
                    ...
                    href={href}
                    target="_blank"
                    className="w-12 h-12 grid place-items-center ring-inset ring- ring-zinc-50/5 rounded-lg transition-[background-color,color] hover:bg-zinc-50 hover:text-zinc-950
        ...
        <form 
        action="https://getform.io/f/ajjjvlna"
        method="POST" 
        ...
        >
                <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                    ...
                    <div className="mb-4">
                        ...
                        autoComplete="email"
                        required
                        placeholder="igocheanthonyode@gmail.com"
                        className="text-field reveal-up" 
                        />
                ...
                <div className="mb-4">
                    ...
                    name="message" 
                    id="message"
                    placeholder="Send in you request!" 
                    required
